...
export const GALLERY_IMAGES: GalleryImage[] = [
  { id: 'g1', url: 'assets/vil1.jpg', title: 'ଶ୍ରୀ ଶ୍ରୀ ଗୋପୀନାଥ ଦେବ', description: 'ବଡପଥୁରିଆ ଜୀବନର ଏକ ଫଟୋ' },
  { id: 'g2', url: 'assets/vil2.jpg', title: 'ଆମ ଗାଁ ଶିବ ମନ୍ଦିର', description: 'ବଡପଥୁରିଆ ଜୀବନର ଏକ ଫଟୋ' },
  { id: 'g3', url: 'assets/vil3.jpg', title: 'ବୋଲ୍ ବମ ୨୦୨୪', description: 'ବଡପଥୁରିଆ ଜୀବନର ଏକ ଫଟୋ' },
  { id: 'g4', url: 'assets/vil4.jpg', title: 'ବାଲୁକା କଳା', description: 'ବଡପଥୁରିଆ ଜୀବନର ଏକ ଫଟୋ' },
  { id: 'g5', url: 'assets/vil5.jpg', title: 'ଗାଁ ପର୍ବତ ଶୀର୍ଷ', description: 'ବଡପଥୁରିଆ ଜୀବନର ଏକ ଫଟୋ' },
  { id: 'g6', url: 'assets/vil6.jpg', title: 'ପ୍ରାଥମିକ ବିଦ୍ୟାଳୟ ପୁରସ୍କାର ବଣ୍ଟନ', description: 'ବଡପଥୁରିଆ ଜୀବନର ଏକ ଫଟୋ' },
  { id: 'g7', url: 'assets/vil7.jpg', title: 'ପଶା ଖେଳ', description: 'ବଡପଥୁରିଆ ଜୀବନର ଏକ ଫଟୋ' },
  { id: 'g8', url: 'assets/vil8.jpg', title: 'ଗୋଲାକାର ଆଲୋଚନା ', description: 'ବଡପଥୁରିଆ ଜୀବନର ଏକ ଫଟୋ' },
  { id: 'g9', url: 'assets/vil9.jpg', title: 'ଗାଁ ପଡିଆର ଦୃଶ୍ୟ', description: 'ବଡପଥୁରିଆ ଜୀବନର ଏକ ଫଟୋ' },
  { id: 'g10', url: 'assets/vil10.jpg', title: 'ଶିବ ମନ୍ଦିର କାମ', description: 'ବଡପଥୁରିଆ ଜୀବନର ଏକ ଫଟୋ' },
  { id: 'g11', url: 'assets/vil11.jpg', title: 'ଶିବ ମନ୍ଦିର କାମ', description: 'ବଡପଥୁରିଆ ଜୀବନର ଏକ ଫଟୋ' },
  { id: 'g12', url: 'assets/vil12.jpg', title: 'ଗାଁ ଦୃଶ୍ୟ', description: 'ବଡପଥୁରିଆ ଜୀବନର ଏକ ଫଟୋ' },
  { id: 'g13', url: 'assets/vil13.jpg', title: 'ବଡ ସାପ ଦୃଶ୍ୟ ', description: 'ବଡପଥୁରିଆ ଜୀବନର ଏକ ଫଟୋ' },
  { id: 'g14', url: 'assets/vil14.jpg', title: 'ଗୋଷ୍ଠୀ ଫଟୋ |', description: 'ବଡପଥୁରିଆ ଜୀବନର ଏକ ଫଟୋ' },
  { id: 'g15', url: 'assets/vil15.jpg', title: 'ଗ୍ରାମ ଗଣେଶ ପୂଜା', description: 'ବଡପଥୁରିଆ ଜୀବନର ଏକ ଫଟୋ' },
  { id: 'g16', url: 'assets/vil16.jpg', title: 'ଗ୍ରାମ ରାସ୍ତା', description: 'ବଡପଥୁରିଆ ଜୀବନର ଏକ ଫଟୋ' },
  { id: 'g17', url: 'assets/vil17.jpg', title: 'ପୁରସ୍କାର ବଣ୍ଟନ ଦିନ ଫଟୋ', description: 'ବଡପଥୁରିଆ ଜୀବନର ଏକ ଫଟୋ' },
  { id: 'g18', url: 'assets/vil18.jpg', title: 'ବିଲ ଫଟୋ', description: 'ବଡପଥୁରିଆ ଜୀବନର ଏକ ଫଟୋ' },
];
...
export const INITIAL_REVIEWS: Review[] = [
  { id: 'r1', name: 'ସୁକାନ୍ତ କୁମାର ରଥ', content: 'ଗ୍ରାମ ପୋର୍ଟାଲ୍ ଆଗାମୀ ବୈଠକଗୁଡ଼ିକୁ ଦେଖିବା ଏତେ ସହଜ କରିଥାଏ!', rating: 5, avatarUrl: 'assets/review1.jpg' },
  { id: 'r2', name: 'ସୋନୁ', content: 'ଏହି ଡିଜିଟାଲ ପଦକ୍ଷେପ ସହିତ ଆମ ଗାଁ ପ୍ରଗତି କରୁଥିବା ଦେଖି ଗର୍ବିତ।', rating: 5, avatarUrl: 'assets/review2.jpg' },
  { id: 'r3', name: 'ସରୋଜ ପରିଡା ', content: 'ଯୁବପିଢ଼ିଙ୍କୁ ଆମର ପରମ୍ପରା ସହିତ ଯୋଡ଼ି ହେବା ପାଇଁ ଏକ ମହାନ ପ୍ଲାଟଫର୍ମ।', rating: 5, avatarUrl: 'assets/review3.jpg' },
